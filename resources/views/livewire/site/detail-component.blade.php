                ...
                <div class="wrap-product-detail">
                    <div class="detail-media" >
                        <div class="product-gallery" >
                          <ul class="slides">
                        @foreach ($imgs as $img)
                           <li data-thumb="{{$img->photo}}">
                                <img src="{{$img->photo}}" width: 109.25px; margin-right: 10px; alt="product thumbnail" />
                            </li> 
                        @endforeach
                    ...
                    <div class="detail-info">
                        ...
                        <div class="stock-info in-stock">
                            <p class="availability">Availability: <b>{{$product->manage_stock == '1' ?'in stock' :'out of stock'}}</b></p>
                        </div>
                        <div class="quantity">
                            <span>Quantity:</span>
                            ...
                            @foreach ($related_products as $products)
                                ...
                                <div class="product product-style-2 equal-elem">
                                    <div class="product-thumnail">
                                        <a href="{{route('product.detail',$products->slug)}}" title="T-Shirt Raw Hem Organic Boro Constrast Denim">
                                            <figure><img src="{{$products->images[0]->photo}}" width="214" height="214" alt="T-Shirt Raw Hem Organic Boro Constrast Denim"></figure>
                                        </a>
                                        ...
                                        <div class="wrap-btn">
                                            <a href="{{route('product.detail',$products->slug)}}" class="function-link">quick view</a>
                                        </div>
                                    </div>
                                    <div class="product-info">
