                            ...
                            <li class="col-lg-4 col-md-6 col-sm-6 col-xs-6 ">
                                <div class="product product-style-3 equal-elem ">
                                    ...
                                    <div class="product-info">
                                        ...
                                        <a  href="{{route('add.to.cart',$product ->id)}}"  class="btn add-to-cart"> Addd To Cart</a>
                        ...
                        <div class="widget-content">
                            <ul class="list-category">
                                ...
                                <li class="category-item has-child-cate">
                                    <a href="{{route('category.slug',$category->slug)}}" class="cate-link">{{$category->name}}</a>
                                    @if ($category->childrens)
                                    <span class="toggle-control">+</span>
                                        <ul class="sub-cate">
                                        @foreach ($category->childrens as $children)

                                            <li class="category-item"><a href="{{route('category.slug',$children->slug)}}" class="cate-link">{{$children->name}}</a></li>
                                        @endforeach
