                ...
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"> أضافه سليدر
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title" id="basic-layout-form"> أضافة سليدر جديد </h4>
                                ...
                                <div class="card-body">
                                    <form class="form"
                                        ...
                                        <div class="form-body">
                                            ...
                                            <h4 class="form-section"><i class="ft-home"></i> صور الاسليدر </h4>
                                            <div class="form-group">
...
<script>
   ...
   Dropzone.options.dpzMultipleFiles = {
       ...
       ,
       url: "{{route('slider.save') }}", // Set the url
       success:
