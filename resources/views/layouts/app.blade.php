					...
					<div class="primary-nav-section">
						<div class="container">
							<ul class="nav primary clone-main-menu" id="mercado_main" data-menuname="Main menu" >
								...
								<li class="menu-item">
									<a href="about-us.html" class="link-term mercado-item-title">{{trans('site.about us')}}</a>
								</li>
								<li class="menu-item">
									<a href="{{route('shop')}}" class="link-term mercado-item-title">{{trans('site.shop')}}</a>
								</li>
								<li class="menu-item">
									<a href="{{route('cart')}}" class="link-term mercado-item-title">{{trans('site.card')}}</a>
								</li>
								<li class="menu-item">
									<a href="{{route('checkout')}}" class="link-term mercado-item-title">{{trans('site.checkout')}}</a>
								</li>
								<li class="menu-item">
									<a href="contact-us.html" class="link-term mercado-item-title">{{trans('site.contact us')}}</a>
								</li>																	
							</ul>
						</div>
					</div>
